...
async function getStaticProps() {
  //fetch data from an API\
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://Pratyush1108:ABCs123dfrgh@cluster0.ew3im.mongodb.net/myFirstDatabase?retryWrites=true&w=majority");
  const db = client.db();
